...
/**
 * Maps a {@code marketId} to its base/quote {@link Asset} pair — the AE's anti-corruption
 * translation of the matching context's market identity into money terms. Ids/symbols mirror the
 * matching engine's {@code MarketInfo} (single source of truth), kept as an owned copy so the
 * Assets Engine has no cross-context dependency.
 */
