...
public final class DepositAckDecoder
{
    ...
    private final DepositAckDecoder parentMessage = this;
    ...
    public DepositAckDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public DepositAckDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[DepositAck](sbeTemplateId=");
    ...
    public DepositAckDecoder sbeSkip()
    {
        sbeRewind();
