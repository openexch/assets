...
public final class WithdrawAckEncoder
{
    ...
    private final WithdrawAckEncoder parentMessage = this;
    ...
    public WithdrawAckEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public WithdrawAckEncoder wrapAndApplyHeader(
    ...
    public WithdrawAckEncoder correlationId(final long value)
    {
    ...
    public WithdrawAckEncoder userId(final long value)
    {
    ...
    public WithdrawAckEncoder assetId(final int value)
    {
    ...
    public WithdrawAckEncoder amount(final long value)
    {
    ...
    public WithdrawAckEncoder newAvailable(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final WithdrawAckDecoder decoder = new WithdrawAckDecoder();
