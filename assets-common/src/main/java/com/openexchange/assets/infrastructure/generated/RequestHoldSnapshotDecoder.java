...
public final class RequestHoldSnapshotDecoder
{
    ...
    private final RequestHoldSnapshotDecoder parentMessage = this;
    ...
    public RequestHoldSnapshotDecoder wrap(
    ...
    public RequestHoldSnapshotDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public RequestHoldSnapshotDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[RequestHoldSnapshot](sbeTemplateId=");
    ...
    public RequestHoldSnapshotDecoder sbeSkip()
    {
        sbeRewind();
