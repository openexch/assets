...
/**
 * Reserve funds for an order (available -&gt; locked)
 */
...
public final class HoldEncoder
{
    ...
    private final HoldEncoder parentMessage = this;
    ...
    public HoldEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public HoldEncoder wrapAndApplyHeader(
    ...
    public HoldEncoder correlationId(final long value)
    {
    ...
    public HoldEncoder orderId(final long value)
    {
    ...
    public HoldEncoder userId(final long value)
    {
    ...
    public HoldEncoder assetId(final int value)
    {
    ...
    public HoldEncoder amount(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final HoldDecoder decoder = new HoldDecoder();
