...
public final class JournalDepositDecoder
{
    ...
    private final JournalDepositDecoder parentMessage = this;
    ...
    public JournalDepositDecoder wrap(
    ...
    public JournalDepositDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public JournalDepositDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[JournalDeposit](sbeTemplateId=");
    ...
    public JournalDepositDecoder sbeSkip()
    {
        sbeRewind();
