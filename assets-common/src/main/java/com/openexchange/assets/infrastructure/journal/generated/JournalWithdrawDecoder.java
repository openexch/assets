...
public final class JournalWithdrawDecoder
{
    ...
    private final JournalWithdrawDecoder parentMessage = this;
    ...
    public JournalWithdrawDecoder wrap(
    ...
    public JournalWithdrawDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public JournalWithdrawDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[JournalWithdraw](sbeTemplateId=");
        ...
        builder.append(this.balanceAfter());
        builder.append('|');
    ...
    public JournalWithdrawDecoder sbeSkip()
    {
        sbeRewind();
