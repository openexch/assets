...
public final class HoldSnapshotEndEncoder
{
    ...
    private final HoldSnapshotEndEncoder parentMessage = this;
    ...
    public HoldSnapshotEndEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public HoldSnapshotEndEncoder wrapAndApplyHeader(
    ...
    public HoldSnapshotEndEncoder correlationId(final long value)
    {
    ...
    public HoldSnapshotEndEncoder entryCount(final int value)
    {
