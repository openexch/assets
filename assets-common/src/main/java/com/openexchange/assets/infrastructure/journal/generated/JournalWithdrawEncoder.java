...
/**
 * An APPLIED withdrawal: amount debited from the user's available balance. balanceAfter = post-debit (available + locked) total. clusterTimeMs = deterministic cluster timestamp of the applying log entry.
 */
@SuppressWarnings("all")
public final class JournalWithdrawEncoder
{
    ...
    private final JournalWithdrawEncoder parentMessage = this;
    ...
    public JournalWithdrawEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public JournalWithdrawEncoder wrapAndApplyHeader(
    ...
    public JournalWithdrawEncoder journalSeq(final long value)
    {
    ...
    public JournalWithdrawEncoder userId(final long value)
    {
    ...
    public JournalWithdrawEncoder assetId(final int value)
    {
    ...
    public JournalWithdrawEncoder amount(final long value)
    {
    ...
    public static int balanceAfterId()
    {
        return 5;
    }

    public static int balanceAfterSinceVersion()
    {
        return 0;
    }

    public static int balanceAfterEncodingOffset()
    {
        return 28;
    }

    public static int balanceAfterEncodingLength()
    {
        return 8;
    }

    public static String balanceAfterMetaAttribute(final MetaAttribute metaAttribute)
    {
        if (MetaAttribute.PRESENCE == metaAttribute)
        {
            return "required";
    ...
    public static long balanceAfterNullValue()
    {
        return -9223372036854775808L;
    }

    public static long balanceAfterMinValue()
    {
        return -9223372036854775807L;
    }

    public static long balanceAfterMaxValue()
    {
        return 9223372036854775807L;
    }

    public JournalWithdrawEncoder balanceAfter(final long value)
    {
    ...
    public JournalWithdrawEncoder clusterTimeMs(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final JournalWithdrawDecoder decoder = new JournalWithdrawDecoder();
