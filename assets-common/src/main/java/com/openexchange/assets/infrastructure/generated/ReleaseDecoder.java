...
public final class ReleaseDecoder
{
    ...
    private final ReleaseDecoder parentMessage = this;
    ...
    public ReleaseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ReleaseDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[Release](sbeTemplateId=");
