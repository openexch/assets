...
public final class HoldRejectDecoder
{
    ...
    public HoldRejectDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public HoldRejectDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[HoldReject](sbeTemplateId=");
    ...
    public HoldRejectDecoder sbeSkip()
    {
        sbeRewind();
