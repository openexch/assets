...
/**
 * An APPLIED deposit: amount credited to the user's available balance. balanceAfter = post-credit (available + locked) total. clusterTimeMs = deterministic cluster timestamp of the applying log entry.
 */
@SuppressWarnings("all")
public final class JournalDepositEncoder
{
    ...
    private final JournalDepositEncoder parentMessage = this;
    ...
    public JournalDepositEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public JournalDepositEncoder wrapAndApplyHeader(
    ...
    public JournalDepositEncoder journalSeq(final long value)
    {
    ...
    public JournalDepositEncoder userId(final long value)
    {
    ...
    public JournalDepositEncoder assetId(final int value)
    {
    ...
    public JournalDepositEncoder amount(final long value)
    {
    ...
    public JournalDepositEncoder balanceAfter(final long value)
    {
    ...
    public JournalDepositEncoder clusterTimeMs(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final JournalDepositDecoder decoder = new JournalDepositDecoder();
