...
public final class BalanceSnapshotEndDecoder
{
    ...
    private final BalanceSnapshotEndDecoder parentMessage = this;
    ...
    public BalanceSnapshotEndDecoder wrap(
    ...
    public BalanceSnapshotEndDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public BalanceSnapshotEndDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[BalanceSnapshotEnd](sbeTemplateId=");
    ...
    public BalanceSnapshotEndDecoder sbeSkip()
    {
        sbeRewind();
