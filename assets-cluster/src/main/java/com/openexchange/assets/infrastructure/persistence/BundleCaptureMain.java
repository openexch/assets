...
/**
 * The Assets Engine's entry point into the shared bundle machinery.
 *
 ...
 * nothing about money; this class supplies the one fact it cannot derive, which
 * wire schema this engine speaks.
 *
...
public final class BundleCaptureMain {
    ...
    public static void main(final String[] args) {
        BundleCapture.run(args, new BundleCapture.EngineSchema(
                SettlementAppliedEncoder.SCHEMA_ID,
                SettlementAppliedEncoder.SCHEMA_VERSION));
    }
}
