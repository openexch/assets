...
public class FollowerReadinessTest {
    ...
    private static NodeReadiness readinessOf(final AssetsClusteredService service) throws Exception {
        final Field f = AssetsClusteredService.class.getDeclaredField("readiness");
        f.setAccessible(true);
        return (NodeReadiness) f.get(service);
    }

    private static void inject(final AssetsClusteredService service, final String field,
                               final Object value) throws Exception {
        final Field f = AssetsClusteredService.class.getDeclaredField(field);
        f.setAccessible(true);
        f.set(service, value);
    }
